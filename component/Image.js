...
var Image = (function (_super) {
    ...
    Image.prototype.render = function () {
        ...
        if (this.state.hasError)
            return fallbackUI;
        return (React.createElement("figure", { className: (0, classnames_1.default)(classNames_1.bulmaClassName.image, className, (0, modifiers_1.modifierPropsToClassnamesObject)(modifiersProps), (0, classNames_1.trunxPropsToClassnamesObject)({
                is1by1: is1by1,
                is1by2: is1by2,
                is1by3: is1by3,
                is2by1: is2by1,
