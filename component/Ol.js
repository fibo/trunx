...
var Ol = (function (_super) {
    ...
    Ol.prototype.render = function () {
        ...
        if (this.state.hasError)
            return fallbackUI;
        return (React.createElement("ol", tslib_1.__assign({ className: classnames(className, classNames_1.trunxPropsToClassnamesObject({ isActive: isActive })) }, props), children));
    };
    return Ol;
}(React.Component));
exports.Ol = Ol;
