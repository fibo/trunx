...
react_2.storiesOf('Elements/Notification', module)
    ...
    react_1.default.createElement(Notification_1.default, { isDanger: true },
        react_1.default.createElement(Delete_1.default, null),
        loremIpsum()))); });
react_2.storiesOf('Elements/Tag', module)
    .add('Colors', function () { return (react_1.default.createElement(react_1.Fragment, null,
    react_1.default.createElement(Tag_1.default, { isBlack: true }, "Black"),
    react_1.default.createElement(Tag_1.default, { isDark: true }, "Dark"),
    react_1.default.createElement(Tag_1.default, { isLight: true }, "Light"),
    react_1.default.createElement(Tag_1.default, { isWhite: true }, "White"),
    react_1.default.createElement(Tag_1.default, { isPrimary: true }, "Primary"),
    react_1.default.createElement(Tag_1.default, { isLink: true }, "Link"),
    react_1.default.createElement(Tag_1.default, { isInfo: true }, "Info"),
    react_1.default.createElement(Tag_1.default, { isSuccess: true }, "Success"),
    react_1.default.createElement(Tag_1.default, { isWarning: true }, "Warning"),
    react_1.default.createElement(Tag_1.default, { isDanger: true }, "Danger"))); });
