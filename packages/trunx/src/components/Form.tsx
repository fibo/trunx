import { FC, FormEvent, FormEventHandler, FormHTMLAttributes, PropsWithChildren } from "react"
 ...
 * ```
 */
export const formValues = (event: FormEvent<HTMLFormElement>, fields: ReadonlyArray<string>) => {
